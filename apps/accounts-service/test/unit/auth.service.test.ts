...
describe('AuthService', () => {
  ...
  describe('validateJwt', () => {
    it('should validate access token', async () => {
      ...
      jest.spyOn(jwtService, 'verifyAsync').mockResolvedValue(decodedAccessToken);
  ...
  describe('validateRefreshJwt', () => {
    it('should validate refresh token', async () => {
      ...
      jest.spyOn(jwtService, 'verifyAsync').mockResolvedValue(decodedRefreshToken);

      // when
      const { data, status } = await authService.validateRefreshJwt(refreshToken);
