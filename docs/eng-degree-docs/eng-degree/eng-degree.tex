...
Jednym z kluczowych aspektów tego wyzwania jest efektywne segregowanie i recykling odpadów, co przyczynia się nie tylko do ochrony środowiska naturalnego, ale także do potencjalnych oszczędności. Jak podaje EEA (Europejska Agencja Ochrony Środowiska), na obywatela Unii Europejskiej przypada średnio 4,8 ton odpadów komunalnych, z czego 49\% jest recyklingowanych \cite{eea-waste}. Recykling może przynieść znaczące korzyści gospodarcze i środowiskowe, w tym zmniejszenie emisji gazów cieplarnianych, ograniczenie zużycia surowców naturalnych oraz tworzenie miejsc pracy. W samej Polsce, między latami 2004 i 2020, procent recyklingu odpadów komunalnych wzrósł z poziomu 4,9 do 38.7\%.
...
Z uwagi na szeroką ofertę darmowych rozwiązań, zespół zdecydował się na wykorzystanie chmury Microsoft Azure.
Aplikacja serwerowa oparta jest na mikroserwisach, co pozwala na wysoką skalowalność, przy zachowaniu racjonalnych kosztów. W czasie trwania testów oraz tworzenia aplikacji, zespół w pełni wykorzystał pułap darmowy od Microsoft, dzięki czemu nie poniósł żadnych kosztów.

Diagram rozwiązania prezentuje się następująco:
% Naprawić pozycjonowanie
\begin{figure}[h]
    \centering\includegraphics[width=12cm]{./static/architecture-diagram.png} %TODO: Fix source positioning
    \caption{Diagram infrastruktury aplikacji serwerowej.\newline Źródło: Opracowanie własne}
    \label{fig:Diag}
\end{figure}
...
\begin{thebibliography}{9}
    \bibitem{gus} GUS - Ochrona środowiska 2022. - \url{https://stat.gov.pl/download/gfx/portalinformacyjny/pl/defaultaktualnosci/5484/1/23/1/ochrona_srodowiska_2022.pdf}
    \bibitem{eea-waste} Waste \& Recycling, 03.11.2023r. \url{https://www.eea.europa.eu/en/topics/in-depth/waste-and-recycling?size=n_10_n&filters%5B0%5D%5Bfield%5D=readingTime&filters%5B0%5D%5Btype%5D=any&filters%5B0%5D%5Bvalues%5D%5B0%5D%5Bname%5D=All&filters%5B0%5D%5Bvalues%5D%5B0%5D%5BrangeType%5D=fixed&filters%5B1%5D%5Bfield%5D=issued.date&filters%5B1%5D%5Btype%5D=any&filters%5B1%5D%5Bvalues%5D%5B0%5D=Last%205%20years&filters%5B2%5D%5Bfield%5D=language&filters%5B2%5D%5Btype%5D=any&filters%5B2%5D%5Bvalues%5D%5B0%5D=en}
    \bibitem{eea-municipal} Municipal waste recycling rates in Europe by country \url{https://www.eea.europa.eu/data-and-maps/daviz/municipal-waste-recycled-and-composted-6#tab-chart_7}
    \end{thebibliography}
\end{document}
