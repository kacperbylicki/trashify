...
Marek Gerszendorf -- Zaangażowany w rozwój aplikacji mobilnej w języku Swift. Jego doświadczenie w dziedzinie UI/UX odegrało kluczową rolę w stworzeniu przyjaznego dla użytkownika interfejsu do kategoryzacji obrazów w czasie rzeczywistym.
