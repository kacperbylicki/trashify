...
\begin{figure}[h]
    \textbf{\caption{Poziom recyklingu odpadów komunalnych w krajach Unii Europejskiej.}}
    \centering\includegraphics[width=16cm]{./static/Municipal waste recycling rates in Europe by country.png}\\
    \raggedright\scriptsize{Źródło: Dane za stroną internetową (dostęp: 03.11.2023r.) \url{https://www.eea.europa.eu/en/topics/in-depth/waste-and-recycling}}
\end{figure}
...
\begin{figure}[h]
    \textbf{\caption{Reprezentacja skierowanego grafu acyklicznego}}
...
\begin{figure}[H]
    ...
    \centering{\includegraphics[width=16cm]{./static/diagrams/diagram-logowania.png}}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}

\begin{figure}[H]
    \textbf{\caption{Diagram zmiany adresu email}}
    \includegraphics[width=16cm]{./static/diagrams/diagram-zmiany-adresu-email.png}\\
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \includegraphics[width=16cm]{./static/diagrams/diagram-pobierania-danych-smietniczkow.png}\\
    \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm]{./static/diagrams/diagram-rejestracji.png}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \includegraphics[width=16cm]{./static/diagrams/diagram-resetu-hasla.png}\\
    \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    \centering
    \textbf{\caption{Porównanie Zużycia CPU: Flutter vs. Aplikacje Natywne na iOS i Android.}}
    \vspace{0.8em}
