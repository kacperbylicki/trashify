...
\begin{figure}[h]
    ...
    \vspace{0.55em}
    \centering \includegraphics[width=12cm]{static/diagrams/erd-baza-danych-użytkownika.png}
    \\
...
\begin{figure}
    ...
    \centering \includegraphics[width=12cm]{static/diagrams/erd-baza-danych-śmietników.png}
    \\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm]{./static/diagrams/diagram-resetu-hasła.png}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm]{./static/trash-unit.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm]{./static/trash-integration-tests.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm]{./static/accounts-unit.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm]{./static/accounts-integration-tests.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/start-page.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/register.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/login.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/forgot-password.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/home-page.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=8cm,height={\textheight},keepaspectratio]{./static/mobile/add-trash.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/add-trash.jpg}{./static/mobile/user-panel.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/add-trash.jpg}{./static/mobile/update-email.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=8cm, height={\textheight}, keepaspectratio]{./static/mobile/add-trash.jpg}{./static/mobile/update-password.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
