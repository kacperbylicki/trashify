...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \includegraphics[width=12cm]{./static/trash-unit.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \includegraphics[width=12cm]{./static/trash-integration-tests.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \includegraphics[width=12cm]{./static/accounts-unit.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{0.55em}
    \includegraphics[width=12cm]{./static/accounts-integration-tests.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\subsection{Instalacja aplikacji przez użytkownika}

\forceindent Aplikacja mobilna 
...
\begin{itemize}[label=--]
    \item środowiska rozruchomieniowego Node.js w wersj 20.9 bądź nowszej;
