...
Doświadczenie to przekłada się na jego codzienną pracę zawodową, gdzie jako członek zespołu programistów, lepiej rozumie potrzeby przełożonych i jest w stanie szybciej dostarczyć zadowalające rezultaty.
...
Planuje on przygotowanie sobie kodu bazowego do aplikacji opartych o mikroserwisy w innych, bardziej dopasowanych pod niego narzędziach, co dalej pogłębi jego wiedzę na temat sieci komputerowych oraz architektury mikroserwisów.

Projekt ten był również pierwszą jego stycznością z tworzeniem aplikacji mobilnych oraz dostosowywania interfejsu RESTfull API pod potrzeby urządzeń mobilnych.
...
Tworzenie dokumentacji projektu oraz pisanie pracy inżynierskiej przy użyciu środowiska LaTeX było jego pomysłem, które pomimo bardzo optymistycznych założeń, okazało się trudniejsze w praktyce.
