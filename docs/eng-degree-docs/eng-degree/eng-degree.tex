...
\forceindent{Umożliwia przejście do procesu rejestracji poprzez przycisk „Dołącz teraz” (eng. \textit{Join Now}) oraz do ekranu logowania przez kliknięcie w przycisk „Zaloguj się” (eng. \textit{Login}). }

\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{./static/mobile/home-page.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}

Rejestracja 

\forceindent{Użytkownik może założyć konto, podając nazwę użytkownika, adres e-mail oraz hasło. W celu dodatkowej walidacji, hasło należy wprowadzić dwa razy. Po prawidłowym wpisaniu danych, należy kliknąć przycisk „Zarejestruj się” (eng. \textit{Register}). Z ekranu rejestracji istnieje możliwość łatwego przejścia do ekranu logowania poprzez kliknięcie w napis „Zaloguj się” (eng. \textit{Login}).}

\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{./static/mobile/register.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}

Logowanie

\forceindent{Aby zalogować się do aplikacji, użytkownik musi podać swój adres email oraz hasło. Proces logowania zatwierdza się, klikając przycisk „Zaloguj się” (eng. \textit{Login}). Z ekranu logowania istnieje również możliwość przejścia do panelu odzyskiwania hasła poprzez kliknięcie w napis „Zapomniałeś hasła?” (eng. \textit{Forgot password?}) oraz do ekranu rejestracji przez kliknięcie w „Zarejestruj się” (eng. \textit{Register}).}

\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{./static/mobile/login.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}

Panel odzyskiwania hasła

\forceindent{W celu odzyskania hasła, użytkownik powinien podać adres email powiązany z kontem, a następnie zatwierdzić operację za pomocą przycisku „Resetuj Hasło” (eng. \textit{Reset Password}). Po prawidłowym wykonaniu tej operacji, na podany adres email zostanie wysłana wiadomość z linkiem umożliwiającym odzyskanie hasła.}

\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{./static/mobile/forgot-password.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}

Strona główna 

\forceindent{Strona główna prezentuje mapę z oznaczonymi lokalizacjami śmietników. Każdy typ śmietnika jest reprezentowany przez unikalny kolor i ikonę. Kliknięcie na tag śmietnika wyświetla dodatkowe informacje o danym punkcie. Na górze strony znajduje się pole tekstowe umożliwiające wyszukiwanie określonych lokalizacji. Po wpisaniu początku nazwy miasta, automatycznie pojawia się lista sugerowanych pasujących miejsc. Użytkownik może wybrać interesującą go lokalizację z tej listy. Na dole strony umieszczono menu nawigacyjne, dzięki któremu można łatwo poruszać się po aplikacji.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{./static/mobile/user-panel.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=8cm]{./static/mobile/update-email.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=8cm]{./static/mobile/update-password.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
