...
Te technologie umożliwiają efektywną implementację modelu na platformach Apple. \footnote{Dane za stroną internetową (dostęp 06.12.2023) \url{https://developer.apple.com/videos/play/wwdc2019/222}}
...
Ten ekstraktor pozwala na automatyczne wydobycie istotnych cech z obrazów, co jest szczególnie ważne w kontekście uczenia maszynowego. \footnote{}
...
To podejście pozwalało na skupienie się na kluczowych detalach, co przyspieszało proces uczenia i poprawiało skuteczność modelu. \footnote{}
...
Pozwoliło to na zachowanie istotnych informacji przy jednoczesnej redukcji liczby cech, co było szczególnie korzystne dla wydajności modelu. \footnote{}

%5. Ocena Wpływu Cech na Model:
Przeprowadzono analizę wpływu poszczególnych cech na skuteczność modelu.
Cechy, które nie przynosiły znaczącego wkładu w proces rozpoznawania, były poddawane selekcji lub odrzucane, co pozwalało na zoptymalizowanie zestawu cech. \footnote{}

%6. Adaptacja do Specyfiki Problemu:
Dobór cech był dostosowany do specyfiki problemu rozpoznawania obrazów.
Na przykład, w przypadku konkretnego zadania, kluczowe mogą być kształty, tekstury lub charakterystyczne punkty na obiektach. \footnote{}

%7. Ocena Stabilności Cech:
Cechy wybrane do procesu uczenia były również oceniane pod kątem stabilności. Stabilne cechy mają tendencję do lepszego generalizowania się na nowe dane, co wpływa na zdolność modelu do skutecznego rozpoznawania obrazów spoza zbioru treningowego. \footnote{}
...
Wartościowe informacje obejmowały rodzaj klasyfikacji (binarna, wieloklasowa), rozmiar danych, ich złożoność oraz możliwość istnienia nieliniowych zależności. \footnote{}
...
Algorytmy te są efektywne w przetwarzaniu obrazów, zdolne do automatycznego wyodrębniania hierarchicznych cech z danych. \footnote{}
...
Umożliwiają one skuteczne implementowanie modeli opartych na algorytmach CNN na urządzeniach mobilnych. \footnote{}
...
Jego wybór był związany z założeniem, że odpowiednie cechy istotnie wpłyną na skuteczność modelu. \footnote{}
...
Optymalizacja hiperparametrów była kluczowym elementem w dostosowaniu modelu do konkretnego zadania. \footnote{}
...
Oceniano ich zdolność do radzenia sobie z danymi treningowymi i walidacyjnymi oraz ich skuteczność w rozpoznawaniu różnych klas. \footnote{}
...
Możliwe było zastosowanie kombinacji modeli konwolucyjnych i innych algorytmów. \footnote{}
...
\begin{thebibliography}{9}
    ...
    \bibitem{image-classification-cnn} Leiyu Chen, Shaobo Li, Q. Bai, Jing Yang, Sanlong Jiang, Yanming Miao, Review of Image Classification Algorithms Based on Convolutional Neural Networks, College of Mechanical Engineering, Guiyang 550025, Chiny, 21.11.2021
    \bibitem{image-recognition-cnn-algorithms-overview} Genevieve Sapijaszko, W. Mikhael, An Overview of Recent Convolutional Neural Network Algorithms for Image Recognition, IEEE, 01.08.2018
    \bibitem{image-recognition-class-hierarchy} Zhen Yu, Toan N. Nguyen, Y. Gal, Lie Ju, S. Chandra, Lei Zhang, Paul Bonnington, V. Mar, Zhiyong Wang, Z. Ge, Skin Lesion Recognition with Class-Hierarchy Regularized Hyperbolic Embeddings, Medical Image Computing and Computer Assisted Intervention – MICCAI 2022, 16.09.2022
    \bibitem{image-recognition-target-region-selection} Wu Hao, R. Bie, Junqi Guo, Xin Meng, Shenling Wang, Optimized CNN Based Image Recognition Through Target Region Selection, College of Information Science and Technology, Chiny, 16.12.2017
    \bibitem{image-classification-create-ml} Tianyun Wang, Yanzhang Zhu, The CreateML-based compared to the AutoML-based approach to animal image classification, International Conference on Cloud Computing, Performance Computing, and Deep Learning (CCPCDL 2022), Wuhan, Chiny, 13.10.2022
    \bibitem{image-classification-data-augumentation} Jingyuan He, Bailong Yang, Fine-grained Image Recognition Method using Discriminative Region-based Data Augmentation, Frontiers in Computing and Intelligent Systems, 10.2022
