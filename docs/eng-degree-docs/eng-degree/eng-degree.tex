...
Mikroserwis pojemników na śmieci posiada łącznie 6 testów jednostkowych, co przedstawione jest na rysunku 3.8, oraz 9 testów integracyjnych. Przekłada się to na wysoką odporność na potencjalne błędy.

\begin{figure}[htbp]
    \textbf{\caption{Wyniki testów jednostkowych mikroserwisu pojemników na śmieci}}
    \vspace{0.55em}
    \centering\includegraphics[width=12cm,height={\imgth}, keepaspectratio]{./static/trash-unit.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm,height={\imgth}, keepaspectratio]{./static/trash-integration-tests.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm,height={\imgth}, keepaspectratio]{./static/accounts-unit.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \vspace{0.55em}
    \centering\includegraphics[width=12cm,height={\imgth}, keepaspectratio]{./static/accounts-integration-tests.png}
    \\
    \raggedright \scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=8cm, height={\imgth}, keepaspectratio]{./static/mobile/login.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=8cm, height={\imgth}, keepaspectratio]{./static/mobile/forgot-password.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=8cm, height={\imgth}, keepaspectratio]{./static/mobile/home-page.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=8cm,height={\imgth},keepaspectratio]{./static/mobile/add-trash.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}

Panel użytkownika

\forceindent{Umożliwia edycję nazwy użytkownika oraz adresu email. Proces edycji rozpoczyna się od kliknięcia w przycisk „Edytuj” (eng. \textit{Edit}), co przekierowuje do odpowiedniego panelu edycyjnego. Funkcja „Ustawienia dostępu” (eng. \textit{Access settings}) pozwala na przeniesienie do sekcji ustawień, gdzie użytkownik może konfigurować uprawnienia aplikacji. Za pomocą suwaka trybu ciemnego (eng. \textit{dark mode}) istnieje możliwość zmiany wyglądu aplikacji z jasnego na ciemny i odwrotnie. Opcja „Wyloguj się” (eng. \textit{Sign out}) umożliwia bezpieczne wylogowanie się z konta.}

\begin{figure}[h]
    \centering
    \includegraphics[width=8cm, height={\imgth}, keepaspectratio]{./static/mobile/user-panel.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}

Panele edycji nazwy użytkownika i adresu email

\forceindent{Aby edytować nazwę użytkownika, należy wpisać nową nazwę, na którą chcemy ją zmienić, a następnie zatwierdzić zmianę, klikając przycisk „Zapisz” (eng. \textit{Save}). Proces zmiany adresu email przebiega w identyczny sposób: użytkownik wpisuje nowy adres email i zatwierdza zmianę za pomocą tego samego przycisku „Zapisz” (eng. \textit{Save}).}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=8cm, height={\imgth}, keepaspectratio]{./static/mobile/update-password.jpg}\\
    \raggedright\scriptsize{Źródło: Opracowanie własne}
\end{figure}
